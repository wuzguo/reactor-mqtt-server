package com.study.iot.mqtt.common.io;
...
public class FastStringWriter extends Writer {
     ...
     * character sequence <tt>csq</tt>, the entire sequence may not be appended. For instance, invoking the
     * <tt>toString</tt> method of a character buffer will return a subsequence whose content depends upon the buffer's
     * position and limit.
     *
    ...
    public FastStringWriter append(CharSequence csq) {
        String s = (csq == null ? StringPools.NULL : csq.toString());
        write(s, 0, s.length());
        return this;
    }
     ...
     *                                   <tt>end</tt>, or <tt>end</tt> is greater than
     *                                   <tt>csq.length()</tt>
     */
    @Override
    public FastStringWriter append(CharSequence csq, int start, int end) {
        String s = (csq == null ? StringPools.NULL : csq).subSequence(start, end).toString();
        write(s, 0, s.length());
        return this;
    }
