...
public class ConvertUtils {
    ...
    /**
     * Convenience operation for converting a source object to the specified targetType, where the target type is a
     * descriptor that provides additional conversion context. Simply delegates to {@link #convert(Object,
     * TypeDescriptor, TypeDescriptor)} and encapsulates the construction of the source type descriptor using {@link
     * TypeDescriptor#forObject(Object)}.
     *
     * @param source     the source object
     * @param targetType the target type
